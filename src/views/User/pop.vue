...
// try {
//   axios.get('http://81.70.17.242:8000/source/get_subject',{
//     params: {
//       subject:'math'
//     }
//   })
...
const fetchData2 = async () => {
 ...
 .catch (error => {
  console.error(error.response); // 处理请求错误
 }
)};

 const fetchData3 = async () => {
// try {
//   axios.get('http://81.70.17.242:8000/source/get_filetype',{'type':'pdf'})
//   .then(response => {
//     tableData.value = response.data;
//     console.log(tableData.value); // 在控制台打印数据或进行其他操作
//     //console.log(tableData.resource_data)
...
// try {
//   axios.get('http://81.70.17.242:8000/source/get')
//   .then(response => {
//     tableData.value = response.data;
//     console.log(tableData.value); // 在控制台打印数据或进行其他操作
//     //console.log(tableData.resource_data)
